...
export default function Recycle() {
  ...
  const [itemType, setItemType] = useState("Cloths"); // default type
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Recycle request submitted for ${itemType}!`);
  };
