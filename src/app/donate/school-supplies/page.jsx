...
export default function DonateSchoolSupplies() {
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 p-6 md:mx-40 mt-16 md:mt-0">
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-semibold text-blue-900 mb-4">Donate School Supplies</h2>
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <input type="text" placeholder="School Supplies Type*" className="border p-2 rounded w-full" required />
