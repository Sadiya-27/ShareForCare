...
export default function DonateCloths() {
  ...
  const [showDonateDropdown, setShowDonateDropdown] = useState(true); // open by default for Donate
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 p-6 md:mx-40 mt-16 md:mt-0">
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-semibold text-blue-900 mb-4">Donate Cloths</h2>
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <label className="w-full h-40 border-2 border-dashed border-gray-300 flex justify-center items-center rounded-lg cursor-pointer bg-gray-100">
              {image ? (
                <Image src={image} alt="Upload" width={200} height={200} className="object-cover" />
              ) : (
            ...
            <input type="text" placeholder="Cloth Type*" className="border p-2 rounded w-full" required />
            ...
            <button type="submit" className="w-full bg-blue-900 text-white p-3 rounded-lg">
              Submit
            </button>
          </form>
        </div>
